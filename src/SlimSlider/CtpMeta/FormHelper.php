...
class FormHelper
{
     ...
     * class version.
     */
    public const ADMINVERSION = '3.3.0';
     ...
     * @return string [type]          [description]
     */
    public function select( $options = [], $fieldname = 'name', $js = 'do_some_js_action', $required = false )
    {
        $defualt_select = null;
     ...
     */
    public function categorylist( $fieldname = null, $args = [] )
    {
        $catlist_args = [
            'show_option_all'   => '',
            'show_option_none'  => '',
    ...
    public function input_val( $input_field = null )
    {
        ...
        if ( isset( $_data[ $input_field ] ) ) {
            return sanitize_text_field( $_data[ $input_field ] );
        }
    ...
    public function verify_nonce( $noncefield = '_swa_page_wpnonce' )
    {
        ...
        if ( ! isset( $_data[ $noncefield ] ) || ! wp_verify_nonce( $_data[ $noncefield ] ) ) {
            return false;
        }
